...
description: Open a GitHub pull request with repo-specific PR conventions.
when-to-use:
- create pull request, open PR, submit for review
- After changes are committed and ready
category: release
---
...
Use `$BASE` throughout (typically `main` or `master`). Fall back to `main` if detection fails.
