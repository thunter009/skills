---
name: firecrawl
description: Use Firecrawl only for JS-heavy web pages Tavily cannot render.
when-to-use:
- firecrawl, JS-heavy page, scrape rendered page
- When Tavily extract or search fails
category: web
---
