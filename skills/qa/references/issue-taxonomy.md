...
<!-- Severity levels: critical, high, medium, low. Categories: visual, functional, ux, content, performance, console, accessibility. -->
...
1. **Visual scan** — Take screenshot (`playwright-cli screenshot --filename=page.png`). Look for layout issues, broken images, alignment.
...
6. **Console** — Run `playwright-cli console` after interactions. Any new JS errors or failed requests?
